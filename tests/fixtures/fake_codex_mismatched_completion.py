...
for raw_line in sys.stdin:
    ...
    if method == "initialize":
        send({"id": request_id, "result": {"userAgent": "fake-mismatched-completion"}})
        ...
        send({"method": "turn/completed", "params": {"threadId": "thread_scope", "turn": {"id": "turn_foreign", "status": "completed", "items": []}}})
    else:
